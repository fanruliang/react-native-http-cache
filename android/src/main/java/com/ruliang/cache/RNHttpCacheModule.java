...
public class RNHttpCacheModule extends ReactContextBaseJavaModule {

  private final ReactApplicationContext reactContext;

  public RNHttpCacheModule(ReactApplicationContext reactContext) {
    super(reactContext);
